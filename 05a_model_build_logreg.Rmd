...
## export model object
```{r}
away_roc <- list(auc=`away win_roc_data`$auc,sensitivities=`away win_roc_data`$sensitivities,specificities=`away win_roc_data`$specificities)
home_roc <- list(auc=`away win_roc_data`$auc,sensitivities=`away win_roc_data`$sensitivities,specificities=`away win_roc_data`$specificities)
tie_roc <- list(auc=`away win_roc_data`$auc,sensitivities=`away win_roc_data`$sensitivities,specificities=`away win_roc_data`$specificities)
